...
- **2026-08-15** — Godot collect/scenario: fixture Performance snapshot → `frame_time` artifact; confirm-only addon (`issue/43-godot-collect-scenario`).
- **2026-08-14** — Godot detect/doctor: `project.godot` evidence; missing binary blocks with exit 3 (`issue/42-godot-detect-doctor`).
